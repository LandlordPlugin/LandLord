...
public class ShopGUI extends AbstractGUI {
    ...
    protected void create() {
        ...
        back5.addClickAction((p) -> {
            ...
            if (claims + delta - 5 < 0) {
                cost -= this.costManager.calculateCost(claims + delta, claims + delta - 5);
                delta = -claims;
            } else {
        ...
        back10.addClickAction((p) -> {
            ...
            if (claims + delta - 10 < 0) {
                cost -= this.costManager.calculateCost(claims + delta, claims + delta - 10);
                delta = -claims;
            } else {
        ...
        confirm.setName(lm.getRawString("Shop.gui.confirm"));
